...
function library:Notification(NotificationInfo)
    ...
    notificationText.BackgroundTransparency = 0.8
...
function library:Window(Info)
    ...
    fixLine.BackgroundTransparency = 0.8
    ...
    function insidewindow:Button(Info)
        ...
        fixLine1.BackgroundTransparency = 0.8
    ...
    function insidewindow:Prompt(Info)
        ...
        prompt.BackgroundTransparency = 0.8
        ...
        promptUICorner.CornerRadius = UDim.new(0, 8)
        ...
        promptFixLine.BackgroundTransparency = 0.8
        ...
        confirmPromptButton.Position = UDim2.fromScale(0.8, 0.263)
    ...
    function insidewindow:Label(Info)
        ...
        labelFixLine.BackgroundTransparency = 0.8
    ...
    function insidewindow:Toggle(Info)
        ...
        outerFrame.BackgroundTransparency = 0.8
        outerFrame.BorderSizePixel = 0
        ...
        outerFrame.BackgroundTransparency = Info.Default and 0 or 0.8
        ...
        function insidetoggle:Set(ToggleInfo)
            ...
            TweenService:Create(outerFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut),{BackgroundTransparency = ToggleInfo.Bool and 0 or 0.8}):Play()
        end
        ...
        toggleTextButton.MouseButton1Click:Connect(function()
            ...
            TweenService:Create(outerFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut),{BackgroundTransparency = Toggled and 0 or 0.8}):Play()
        end)
    ...
    function insidewindow:Dropdown(Info)
        ...
        dropdownContainerBackground.BackgroundTransparency = 0.8
        ...
        dropdownFixLine1.BackgroundTransparency = 0.8
        ...
        dropdownUICorner1.CornerRadius = UDim.new(0, 8)
        ...
        function insidedropdown:Button(Info2)
            ...
            buttonDropdown.BackgroundTransparency = 0.8
            ...
            dropdownButtonUICorner.CornerRadius = UDim.new(0, 8)
    ...
    function insidewindow:Keybind(Info)
        ...
        keybindUICorner.CornerRadius = UDim.new(0, 8)
        ...
        keybindFixLine.BackgroundTransparency = 0.8
        ...
        keybindHolder.BackgroundTransparency = 0.8
        ...
        keybindHolderUICorner.CornerRadius = UDim.new(0, 8)
    ...
    function insidewindow:Slider(Info)
        ...
        outerSlider.BackgroundTransparency = 0.8
    ...
    fixLine2.BackgroundTransparency = 0.8
